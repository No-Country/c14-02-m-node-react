	...
	return (
		<section className="flex items-center justify-center bg-black bg-opacity-50">
			<div className="bg-white p-8 max-w-md mx-auto my-8 rounded-md shadow-md">
				...
				<p className="text-gray-600 text-sm mt-4">
					I agree to treat everyone in the Airbnb community-regardlessof their race, religion,
					nation origen, ethnicity, skin color, disability, sex, gender identity, sexual orientation
