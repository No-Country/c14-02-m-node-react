    ...
    <div className="border-y p-4 my-5">
      ...
      <div className="mt-8">
        ...
        <p className="my-5">
          ...
          calles comerciales en la zona, supermercados, tiendas de conveniencia
          y farmacias a 5 minutos a pie. Si quieres encontrar buenos bares y
          restaurantes, pregúntanos.
        </p>
