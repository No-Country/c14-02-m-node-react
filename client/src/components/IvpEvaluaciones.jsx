	...
	return (
		<div className="border-b">
			<div className="m-10">
				...
				<div className="mt-6">
					<p>
						Permíteme empezar diciendo que Megumi fue un anfitrión muy agradable y amable. Es
						extremadamente comunicativo y se aleja para ayudarte. La estancia está escondida en el
						barrio sumida de Toyo, que está fuera del ajetreo y el bullicio, por lo que si estás
...
export default IvpEvaluaciones;
