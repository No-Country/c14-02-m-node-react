      ...
      <div className="border-b py-3">
        <div className="flex">
          ...
          <div className="flex-1 p-4 mr-4">
            ...
            <ul className="list-none pl-0">
              <li className="mb-3">No se indicó si hay detector de monóxido de carbono</li>
          ...
          <div className="flex-1 p-4">
            ...
            <ul className="list-none pl-0">
              ...
              <li className="mb-3">Consultá la política de cancelación completa del anfitrión, que se aplica incluso si cancelás por contagio o algún otro problema causado por el COVID-19.</li>
            </ul>
            <span className="text-lg font-semibold underline">Mostrar más</span>
          </div>
        </div>
